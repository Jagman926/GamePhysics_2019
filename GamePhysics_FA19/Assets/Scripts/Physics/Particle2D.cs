...
public class Particle2D : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        J_Physics.UpdateAcceleration2D(ref acceleration, massInv, ref force);
        J_Physics.UpdateAngularAcceleration2D(ref angularAcceleration.z, inertiaInv, ref torque);
    }
